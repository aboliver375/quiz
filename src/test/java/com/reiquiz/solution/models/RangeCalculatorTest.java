...
import com.reiquiz.solution.RangeCalculator;
...
public class RangeCalculatorTest {
  ...
  public void testRanges() {
    ...
    List<RangePair> expected = new ArrayList<>();
  ...
  private void compareRangeLists(final List<RangePair> expected, final List<RangePair> actual) {
    System.out.println("Actual list: " + actual);
    System.out.println("Expected list: " + expected);
    for (int i = 0; i < expected.size(); i++) {
      System.out.println("Asserting that: " + actual.get(i) + " == " + expected.get(i));
